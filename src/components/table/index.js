...
function Table() {
    return (
        <div class="table">
            ...
            <Button label={"Finalizar compra"} src={check} background="#05A73C" color="white" width="80%" height="50px" margin="15px" fontFamily="'Inter', sans-serif" fontSize="30px" fontWeight="bold" />
        </div>
